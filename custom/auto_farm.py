...
from custom.src.time_utils import now, format_duration, minutes_until_target_time
from custom.src.gsheet_manager import GoogleSheetClient, FastFarmResult
from custom.src.task.my_FastFarmEchoTask import FastFarmEchoTask
...
def run():
    ...
    seconds_to_run = minutes_until_target_time(target_hour=STOP_HOUR, target_minute=STOP_MINUTE) * 60
